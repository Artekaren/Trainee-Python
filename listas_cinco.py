#Desafio45: Generar una lista con los valores flotantes (segundo campo) que sean mayores que el promedio, utilizando una operación funcional para filtrar estos datos.
